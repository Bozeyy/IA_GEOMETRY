...
public class VuePique extends Polygon implements Observateur {
    private Jeu donnees;

    public VuePique(Jeu donnees, int x, int y, Color c, double tailleCase) {
        ...
        double x2 = x1 + demiLargeur;
        double y2 = y1 - hauteur;

        double x3 = x1 + tailleCase;
        double y3 = y1;
