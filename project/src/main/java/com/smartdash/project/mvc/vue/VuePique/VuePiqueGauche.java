...
public class VuePiqueGauche extends Rectangle implements Observateur
{

    private Jeu donnees;

    public VuePiqueGauche(Jeu donnees, int x, int y){
        this.donnees = donnees;
        setFill(new ImagePattern(new Image("pique_gauche.png")));
