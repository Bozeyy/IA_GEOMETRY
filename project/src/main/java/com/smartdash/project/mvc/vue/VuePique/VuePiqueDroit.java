...
public class VuePiqueDroit extends Polygon implements Observateur
{
    private Jeu donnees;

    public VuePiqueDroit(Jeu donnees, int x, int y, Color c,double tailleCase){
        ...
        // dégradé
        LinearGradient gradient = new LinearGradient(1, 0, 0, 0, true, CycleMethod.NO_CYCLE,
