...
public class VuePiqueDroit extends Rectangle implements Observateur
{
    private Jeu donnees;

    public VuePiqueDroit(Jeu donnees, int x, int y){
        this.donnees = donnees;
        setFill(new ImagePattern(new Image("pique_droit.png")));
