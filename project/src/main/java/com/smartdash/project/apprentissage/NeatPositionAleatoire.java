...
public class NeatPositionAleatoire extends NeatAmelioration
{
    /**
     ...
     */
    public NeatPositionAleatoire(int maxGenerations, int nbTerrains) {
    ...
    public void lancerApprentissage() throws Exception {
        ...
        while (generation < maxGenerations) {
            ...
            if (generation % 20 == 0) {
                ...
                moyenneTest = stat.calculerScoreMeilleur(populationCopie);
